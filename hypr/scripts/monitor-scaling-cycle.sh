...
local omarchy_gdk_scale = $NEW_GDK
local omarchy_monitor_scale = $NEW_SCALE
...
hl.monitor({ output = "DP-2", mode = "1920x1080@240",   position = "0x0",          scale = omarchy_monitor_scale })
-- LG FHD 75Hz (derecha física)
hl.monitor({ output = "DP-1", mode = "1920x1080@74.97", position = "${NEW_POS}x0", scale = omarchy_monitor_scale })
