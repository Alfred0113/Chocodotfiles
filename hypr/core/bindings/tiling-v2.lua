...
o.bind("CTRL + ALT + DELETE", "Close all windows", "chocomazapan-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "chocomazapan-hyprland-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "chocomazapan-hyprland-workspace-layout-toggle")
...
-- Monitor scaling cycle (SUPER + code:61) intentionally NOT bound here — the
-- user's own hypr/bindings.lua binds it directly to hypr/scripts/monitor-scaling-cycle.sh.
