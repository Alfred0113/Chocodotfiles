...
ShellRoot {
  ...
  property string imageDirs: Quickshell.env("CHOCOMAZAPAN_IMAGE_SELECTOR_DIRS") || Quickshell.env("CHOCOMAZAPAN_IMAGE_SELECTOR_DIR") || Quickshell.env("CHOCOMAZAPAN_STOCK_BACKGROUNDS_DIR") || (Quickshell.env("HOME") + "/Imágenes/Wallpapers")
  property string imageRows: ""
  property string selectionFile: Quickshell.env("CHOCOMAZAPAN_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("CHOCOMAZAPAN_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("CHOCOMAZAPAN_IMAGE_SELECTOR_SELECTED")
  property string colorsFile: Quickshell.env("CHOCOMAZAPAN_IMAGE_SELECTOR_COLORS_FILE") || (Quickshell.env("HOME") + "/.config/chocomazapan/quickshell-colors.json")
  ...
  property string socketPath: (Quickshell.env("XDG_RUNTIME_DIR") || ("/run/user/" + Quickshell.env("UID"))) + "/wallpaper-selector.sock"
