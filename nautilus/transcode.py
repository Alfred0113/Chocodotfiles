...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("chocomazapan-launch-floating-terminal-with-presentation")
        binary = shutil.which("chocomazapan-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="ChocoMazapanTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("chocomazapan-launch-floating-terminal-with-presentation")
            and shutil.which("chocomazapan-transcode")
        )
